...
drive_list = np.linspace(100., 5000., 256, endpoint=True)
drive_scan_defaults = {'trap_freq':20.0, 'lattice_depth':1.5e3, 'site_spacing_um':1.3,
                             'gamma':0.005, 'drive_freq':1e3,
                             'n_sites':129, 'floquet_m_radius':4, 'sort':False}
scan_name_template = 'direct_drive_scan_m{:d}'
min_m = 20
max_m = 20
...
get_ipython().run_cell_magic('time', '', "for this_rad in progbar(range(min_m, max_m+1)):\n    drive_scan_defaults['floquet_m_radius'] = this_rad\n    this_stem = scan_name_template.format(this_rad)\n    %time do_1D_scan(drive_scan_defaults, 'drive_freq', drive_list, this_stem, base_dir)")
...
base_dir = os.path.join('/media', 'simulationData', 'BreathingLattice', 'floquet', 'mscan')
gamma_list = np.linspace(0.01/256., 0.01, 256, endpoint=True)
gamma_scan_defaults = {'trap_freq':20.0, 'lattice_depth':1.5e3, 'site_spacing_um':1.3,
                             'gamma':0.005, 'drive_freq':1e3,
                             'n_sites':129, 'floquet_m_radius':4, 'sort':False}
scan_name_template = 'direct_gamma_scan_m{:d}'
min_m = 16;
max_m = 16;
...
get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_gamma_scan\', \'direct_gamma_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(8,10.5))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'][:], f[\'floquet_energy\'][:], -50, 50, marker=\',\', ls=\'None\', c=\'k\', modulus=1e3)\n    fig.tight_layout()')


# In[10]:


get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_gamma_deep_scan\', \'direct_gamma_deep_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(8,10.5))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'][:], f[\'floquet_energy\'][:], -100, 100, marker=\',\', ls=\'None\', c=\'k\', modulus=1e3)\n    fig.tight_layout()')


# In[11]:


get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_drive_scan\', \'direct_drive_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(8,10.5))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'], f[\'floquet_energy\'], -50, 50, marker=\',\', ls=\'None\', c=\'k\', modulus=f[\'scan_values\'])\n    fig.tight_layout()')
...
get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_drive_scan\', \'direct_drive_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(15,8))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'], f[\'floquet_energy\'], -20, 50, marker=\',\', ls=\'None\', c=\'k\', modulus=f[\'scan_values\'])\n    ax.set_xlabel(\'$f_{drive}$ [Hz]\')\n    ax.set_ylabel(\'quasienergy $\\\\epsilon/h$ [Hz]\')\n    fig.tight_layout()\n    fig.savefig(outdir + \'drive_quasi_zoom.png\', dpi=150)')


# In[23]:


get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_drive_scan\', \'direct_drive_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(15,8))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'], f[\'floquet_energy\'], -250, 250, marker=\',\', ls=\'None\', c=\'k\', modulus=f[\'scan_values\'])\n    ax.set_xlabel(\'$f_{drive}$ [Hz]\')\n    ax.set_ylabel(\'quasienergy $\\\\epsilon/h$ [Hz]\')\n    fig.tight_layout()\n    fig.savefig(outdir + \'drive_quasi.png\', dpi=150)')


# In[25]:


get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_gamma_scan\', \'direct_gamma_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(15,8))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'][:], f[\'floquet_energy\'][:], -20, 50, marker=\',\', ls=\'None\', c=\'k\', modulus=1e3)\n    ax.set_xlabel(\'$\\\\gamma$\')\n    ax.set_ylabel(\'quasienergy $\\\\epsilon/h$ [Hz]\')\n    fig.tight_layout()\n    fig.savefig(outdir + \'gamma_quasi_zoom.png\', dpi=150)')


# In[27]:


get_ipython().run_cell_magic('time', '', 'with h5py.File(os.path.join(base_dir, \'direct_gamma_scan\', \'direct_gamma_scan_out.h5\'), \'r\', libver="latest") as f:\n    fig = plt.figure(figsize=(15,8))\n    ax = fig.add_subplot(111)\n    gen_energy_plot(ax, f[\'scan_values\'][:], f[\'floquet_energy\'][:], -250, 250, marker=\',\', ls=\'None\', c=\'k\', modulus=1e3)\n    ax.set_xlabel(\'$\\\\gamma$\')\n    ax.set_ylabel(\'quasienergy $\\\\epsilon/h$ [Hz]\')\n    fig.tight_layout()\n    fig.savefig(outdir + \'gamma_quasi.png\', dpi=150)')
