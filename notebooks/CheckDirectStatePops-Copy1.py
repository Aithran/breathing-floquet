...
data_dirs = [os.path.basename(dirpath[:-1]) for dirpath in glob.glob(base_path + "*/")]
data_paths = sorted([os.path.join(base_path, this_dir, this_dir + '_out.h5') for this_dir in data_dirs])
